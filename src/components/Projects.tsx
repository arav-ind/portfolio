...
export default function Projects() {
    return (
        <div id='projects' className='absolute w-full h-full flex flex-col items-center'>
            ...
            <div id='projects-content' className='sm:w-[40%] w-full sm:px-0 px-8 h-full flex flex-col items-start mt-5 gap-4 text-justify'>
                ...
                <div className='flex flex-col items-start mt-5 gap-4'>
                    ...
                    <p className='text-sm'>
                        <b>AstroGO, StingTV,</b> and <b>SwitchTV</b> applications are widely used OTT platforms in Malaysia, 
                ...
                <div className='flex flex-col items-start mt-5 gap-4'>
                    ...
                    <Link className='text-sm italic' href='https://github.com/arav-ind/react-svgmap-india' target='_blank'>Click Here to Checkout!</Link>
                </div>
                <div className='flex flex-col items-start mt-5 gap-4'>
                    <div className='flex items-center justify-start gap-6'>
                        <p className='font-bold text-xl'>
